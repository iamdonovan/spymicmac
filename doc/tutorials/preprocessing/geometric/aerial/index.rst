...
For example camera models and fiducial marker patterns, see :doc:`this page <../../../../cameras>`. Note that this
page is not (yet) exhaustive, and it is possible that there are other fiducial marker patterns for the camera model
